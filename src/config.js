...
// フィールドサイズ追加
// 高さが全部入るように調整
Config.puyoImgHeight = (window.innerHeight-Config.fontHeight)/(Config.stageRows + 2);
...
Config.freeFallingSpeed = 3; // 自由落下のスピード
Config.erasePuyoCount = 4; // 何個以上揃ったら消えるか
Config.eraseAnimationDuration = 30; // 何フレームでぷよを消すか

Config.puyoColors = 5; // 何色のぷよを使うか
Config.playerFallingSpeed = 0.5; // プレイ中の自然落下のスピード
Config.playerDownSpeed = 20; // プレイ中の下キー押下時の落下スピード
